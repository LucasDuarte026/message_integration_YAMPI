...
### 1. `src/domain/` (As Especificações)
...
### 2. `src/core/` (Infraestrutura Base e Clientes Internos)
...
### 3. `src/ports/` (Adaptadores Externos)
...
### 4. `src/workers/` (Regras de Negócio e Use Cases)
