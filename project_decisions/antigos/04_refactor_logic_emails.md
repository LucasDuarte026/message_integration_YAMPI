# Decisão 04: Especificação da Máquina de Estados — Lógica de Emails

**Data de Criação:** 2026-07-21  
**Última Atualização:** 2026-07-21  
**Versão:** 1.0.0  
**Status:** Especificação Aprovada (Implementação Pendente)  
**Escopo:** Definição formal da máquina de estados STG/STC, schema unificado, contratos de workers, macros configuráveis e regras de concorrência.  
**Origem:** Refinamento do [03_mudanca_arquitetura_emails_e_geral.md](./03_mudanca_arquitetura_emails_e_geral.md) após rodada de entrevista de clarificação.
